...
export const Experience = () => {
  return (
    <section id="experience" className="py-14 sm:py-20 bg-[#070b14] border-t border-b border-slate-800/80 relative">
      ...
      <div className="container-custom relative z-10">
        ...
        {/* Full-Width Enterprise Experience Panels with Clean, Uncollapsed Padding */}
        <div className="space-y-6 sm:space-y-8">
          {experienceData.map((exp, idx) => (
            <div
              key={idx}
              className="glass-card p-5 sm:p-7 space-y-5 border border-slate-700/80 hover:border-cyan-500/60 shadow-xl transition-all w-full rounded-2xl"
            >
              ...
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 border-b border-slate-800 pb-4">
                ...
                <div className="flex items-start gap-3.5">
                  <div className="w-10 h-10 rounded-xl bg-cyan-950/90 border border-cyan-500/40 flex items-center justify-center text-cyan-400 flex-shrink-0 mt-0.5 shadow-md">
              ...
              {/* Key Deliverables Grid (Unnested Accent Left Border) */}
              <div className="space-y-2.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 border-l-2 border-cyan-500/40 pl-3.5 py-1">
                  {exp.highlights.map((item, hIdx) => (
                    <div
                      key={hIdx}
                      className="flex items-start gap-2.5 text-slate-300 text-xs leading-relaxed"
                    >
              ...
              <div className="pt-4 border-t border-slate-800/80 flex flex-wrap justify-between items-center gap-3">
                <TelemetryButton
                  traceData={{
                ...
                <span className="text-[11px] font-mono text-emerald-400 font-semibold bg-emerald-950/80 border border-emerald-500/30 px-2.5 py-1 rounded-lg">
                  ✓ Verified Experience
                </span>
              </div>
